...
HD_PWD='C:/Users/Emre/Desktop/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Tetris.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Tetris.tcl -notrace
